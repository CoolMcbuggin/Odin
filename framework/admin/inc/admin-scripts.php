...
function sports_store_admin_register($hook) {
	...
	wp_localize_script( 'wp-color-picker', 'wpColorPickerL10n', array(
		'clear' => 					esc_attr__('Clear', 'sports-store'),
		'clearAriaLabel' => 		esc_attr__('Clear color', 'sports-store'),
		'defaultLabel' => 			esc_attr__('Color value', 'sports-store'),
		'defaultString' => 			esc_attr__('Default', 'sports-store'),
		'defaultAriaLabel' => 		esc_attr__('Select default color', 'sports-store'),
		'pick' => 					esc_attr__('Select Color', 'sports-store'),
	) ); 
